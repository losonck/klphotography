...
Plans:
- [x] 01-01: Scaffold Astro + Tailwind, configure static output, wire repo to CF Pages
- [x] 01-02: Capture current DNS zone snapshot and identify the IEDR-accredited registrar holding klphotography.ie
