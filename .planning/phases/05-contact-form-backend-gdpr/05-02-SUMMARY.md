...
**Corrective 05-02 metadata commit:** `488586d` — `docs(05-02): record summary corrections after Wave 1 commit collision` (this updates 05-02-SUMMARY.md only — runbook content is unchanged from `9780f0d`).
